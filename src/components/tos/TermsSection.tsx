...
const TermsSection: FunctionComponent = () => {
  return (
    <section className="flex items-center justify-center relative overflow-y-auto">
      <div className="relative flex flex-col justify-center items-center w-full container my-20 mx-8">
        ...
        <div className=" mt-10">
          <h1 className="mt-8 text-4xl font-semibold text-red-600">Overview</h1>
          <p className="mt-4 text-xl font-light leading-9">
            The grizzlyhaulingvb.com website is operated by Grizzly Hauling as.
            Throughout the site, the terms "we", "us" and "our" refer to Top
            Grizzly as. Grizzly Hauling as offers this website, including all
            ...
            tools which are added to the current site shall also be subject to
        ...
        <div className=" mt-10">
          <h1 className="mt-8 text-4xl font-semibold text-red-600">Fair Use</h1>
          <p className="mt-4 text-xl font-light leading-9">
            Fair use defines Grizzly Hauling as' exceptions to the rights
            protected by copyright laws. Fair use of grizzlyhaulingvb.com
            includes using copyrighted material: In research In news reporting
            In citations In commentary Fair use of grizzlyhaulingvb.com also
            includes: Linking to grizzlyhaulingvb.com Adding
            grizzlyhaulingvb.com to search engines Library archiving
            grizzlyhaulingvb.com
          </p>
        </div>
        <div className=" mt-10">
          <h1 className="mt-8 text-4xl font-semibold text-red-600">
          ...
          <p className="mt-4 text-xl font-light leading-9">
            ...
            monitor changes to our site. If you discover that the site or its
            contents contains errors, please contact us so these can be
            corrected. Contact address: contact@grizzlyhaulingvbcom
          </p>
        </div>
        <div className=" mt-10">
          <h1 className="mt-8 text-4xl font-semibold text-red-600">
